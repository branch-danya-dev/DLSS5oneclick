...
fn en(key: T) -> &'static str {
    match key {
        ...
        T::Support => "Support project",
        T::Tagline => "More frames. Simpler.",
        T::TipTitle => "Tip",
        T::TipBody => "Pick a game on Games, then Install on Setup. Hotkeys and Feeder defaults apply on the next Install.",
        T::Dismiss => "Dismiss",
        T::YourGames => "Your games",
        T::YourGamesSub => "Install and manage DLSS 5 for games found on this PC.",
        T::TotalGames => "Total games",
        T::InstalledCount => "Ready",
        T::AvailableCount => "Not installed",
...
fn ru(key: T) -> &'static str {
    match key {
        ...
        T::Ready => "Готово",
        T::LeakedBuild => "Leaked Build",
        T::Support => "Поддержать проект",
        T::Tagline => "Больше кадров. Проще.",
        T::TipTitle => "Совет",
        T::TipBody => "Выберите игру на вкладке «Игры», затем «Установить» на странице «Установка». Хоткеи и Feeder-значения применяются при следующей установке.",
        T::Dismiss => "Закрыть",
        T::YourGames => "Ваши игры",
        T::YourGamesSub => "Установка и управление DLSS 5 для найденных игр.",
        T::TotalGames => "Всего игр",
        T::InstalledCount => "Готовы",
        T::AvailableCount => "Не установлено",
